...
## 🔗 Contact Information
- You can contact me through [LinkedIn](https://www.linkedin.com/in/amitgini/) 🤝
...
•	Benchmarked different models (YOLO-NAS, Microsoft OCR) across different  processor’s (CPU, GPU, and NPU) to assess real-time performance and accuracy.

•	Developed automation scripts to collect, analyse, and sort high-quality data for training and validation process, to improve precision and accuracy of the AI Vision model that responsible for real-time anti-phishing detection.
...
•	**Programming Languages**: C, C++, C#, Python, Java, HTML, SQL, NoSQL (MongoDB)

•	**API’s & Library’s:** Gmail, Google Sheets, Gemini, Playwright, OCR utilities

•	**Frameworks & Tools:** VS-Code, Cursor, Linux, Git, GitHub, Conda, Pipenv, Pyenv, Firebase, Jira, Confluence, Slack, TensorFlow, OpenVINO, ONNX, Roboflow.

•	**Expertise**: Data Structures, Algorithms, AI/ML Workflow, ETL, Web Scraping, API Integration, OOP Design Patterns, Task Management Patterns.
